...
//================================================================================================
// CHANGES:
// - events, sprawdzic kiedy bylo zmiana stanu okna
//================================================================================================
// TODO: 
// - stan aplikacji do konsoli
// - kiedy resetowany stan klawiatury - do konsoli w FOX_PrivateAppActive
...
static Uint8 FOX_appstate = 0;	// statyczne, lapiemy sobie stan naszej aplikacji
...
int FOX_PrivateAppActive(Uint8 gain, Uint8 state)
{
	...
	if ( gain ) new_state = (FOX_appstate | state);
	else new_state = (FOX_appstate & ~state);

	// olewamy events ktore nie zmieniaja stanu

	if ( new_state == FOX_appstate ) return(0);
	
	FOX_appstate = new_state;	// aktualizacja stanu
	...
	if ( (state & FOX_APPINPUTFOCUS) && !gain ) FOX_ResetKeyboard();
